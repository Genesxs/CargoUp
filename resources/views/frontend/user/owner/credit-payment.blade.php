            ...
            <div class="col-12">
                <div class="row mt-5">
                    ...
                    <div class="col-12">
                        <div class="alert alert-info text-center">
                            <strong>
                                Darle clic a la imagen para descargar formato de petición de crédito.
                                Una vez diligenciada la solicitud debe subirla.
                            </strong>
                        </div>
                    </div>
                </div>
                <div class="row mt-5 ml-3">
                    ...
                    <div class="col-12 col-lg-8 col-xs-12 d-flex justify-content-center mt-4">
                        @include('frontend.user.includes.credit')
                    </div>
                </div>
                <div class="row mt-5">
                </div>
