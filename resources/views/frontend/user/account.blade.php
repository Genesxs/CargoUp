...
@section('content')
    <div class="container py-4">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="col-12"> @include('includes.partials.messages')</div>
                <div class="col-12">
                    <div class="alert alert-success">Completa la información de "Editar información", una vez completada puedes ir a tablero.</div>
                </div>
                <x-frontend.card>
                    <x-slot name="header">
                        @lang('My Account')
                    ...
                    <x-slot name="body">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <x-utils.link :text="__('Edit Information')" class="nav-link" id="information-tab"
                                    data-toggle="pill" href="#information" role="tab" aria-controls="information"
                                    aria-selected="false" />
                                ...
                                {{-- <x-utils.link
                                    :text="__('I want to be')"
                                    class="nav-link"
                                    id="wantTo"
                                    data-toggle="pill"
                                    href="#want-to-be"
                                    role="tab"
                                    aria-controls="wanto-to-be"
                                    aria-selected="false"/> --}}
                            </div>
                        </nav>
                        ...
                        <div class="tab-content" id="my-profile-tabsContent">
                            ...
                            <div class="tab-pane fade pt-3" id="wantTo" role="tabpanel" aria-labelledby="wanTo-tab">
                                @include(
                                    'frontend.user.account.tabs.want-to-be'
                                )
                            </div>
                            <!--tab-information-->
